...
class Draw:
    ...
    def arc(self, x, y, r, a0, a1, c):
        shapes.arc(self.canvas, x, y, r, a0, a1, c)

    def blit(self, source, x, y, key=-1, palette=None):
        shapes.blit(self.canvas, source, x, y, key, palette)

    def blit_rect(self, buf, x, y, w, h):
        shapes.blit_rect(self.canvas, buf, x, y, w, h)

    def circle(self, x, y, r, c, f=False):
        shapes.circle(self.canvas, x, y, r, c, f)

    def ellipse(self, x, y, r1, r2, c, f=False, m=0b1111, w=None, h=None):
        shapes.ellipse(self.canvas, x, y, r1, r2, c, f, m, w, h)

    def fill(self, c):
        shapes.fill(self.canvas, c)

    def fill_rect(self, x, y, w, h, c):
        shapes.fill_rect(self.canvas, x, y, w, h, c)

    def hline(self, x, y, w, c):
        shapes.hline(self.canvas, x, y, w, c)

    def line(self, x1, y1, x2, y2, c):
        shapes.line(self.canvas, x1, y1, x2, y2, c)

    def pixel(self, x, y, c):
        shapes.pixel(self.canvas, x, y, c)

    def poly(self, x, y, coords, c, f=False):
        shapes.poly(self.canvas, x, y, coords, c, f)

    def polygon(self, points, x, y, c, angle=0, center_x=0, center_y=0):
        shapes.polygon(self.canvas, points, x, y, c, angle, center_x, center_y)

    def rect(self, x, y, w, h, c, f=False):
        shapes.rect(self.canvas, x, y, w, h, c, f)

    def round_rect(self, x, y, w, h, r, c, f=False):
        shapes.round_rect(self.canvas, x, y, w, h, r, c, f)

    def triangle(self, x1, y1, x2, y2, x3, y3, c, f=False):
        shapes.triangle(self.canvas, x1, y1, x2, y2, x3, y3, c, f)

    def vline(self, x, y, h, c):
        shapes.vline(self.canvas, x, y, h, c)
