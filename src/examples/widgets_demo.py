...
display.set_vscroll(38, 20)

button_bar = w.Widget(screen, w=display.width, h=display.tfa, align=w.ALIGN.TOP_LEFT)
status_bar = w.Widget(screen, w=display.width, h=display.bfa, align=w.ALIGN.BOTTOM_LEFT, bg=pal.BLACK)
...
home = w.IconButton(button_bar, x=2, align=w.ALIGN.TOP_LEFT, icon="icons/36dp/home_filled_36dp.png")
toggle = w.ToggleButton(button_bar, x=2, align_to=home, align=w.ALIGN.OUTER_RIGHT, fg=pal.WHITE, bg=None, value=False)
down = w.IconButton(button_bar, x=-2, align=w.ALIGN.TOP_RIGHT, icon="icons/36dp/keyboard_arrow_down_36dp.png")
up = w.IconButton(button_bar, x=-2, align_to=down, align=w.ALIGN.OUTER_LEFT, icon="icons/36dp/keyboard_arrow_up_36dp.png")
...
clock = w.DigitalClock(status_bar, x=-3, y=-1, align=w.ALIGN.BOTTOM_RIGHT, fg=pal.BLACK, bg=button_bar.bg, visible=False)
clock_toggle = w.ToggleButton(status_bar, x=-3, align_to=clock, align=w.ALIGN.OUTER_LEFT, fg=pal.WHITE, bg=None, value=False)
status = w.TextBox(status_bar, w=clock_toggle.x-3, align=w.ALIGN.BOTTOM_LEFT, scale=1)
...
demo_alignments(main_area, button)
